<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="SMDL3.BEVEL.index" %>
<!DOCTYPE html>
<html>
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                         <li class="active"><a href="..\BEVEL\index.aspx"><i class="fa fa-table"></i> <span class="nav-label">Datos</span></a></li>
            ...
            <div class="row">
                ...
                <div class="ibox ">
                    <div class="ibox-title" style="height:100px;">
                        <h5>Dashboard BEVEL [L3] -  Datos por Área</h5>
