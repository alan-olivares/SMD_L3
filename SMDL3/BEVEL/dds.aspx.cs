    ...
    public partial class dds : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                DataTable dt = Funciones.getDataTable("exec sp_Mod_getDDSSem_v2 '" + fecha + "',16");
                Panel1.Controls.Add(new Label { Text = Funciones.crearTablaDDS(dt, semana, "BEVEL [L3]").ToString() });
            }
        }
        }
}