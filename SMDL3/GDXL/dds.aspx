...
<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="dds.aspx.cs" Inherits="SMDL3.GDXL.dds" %>
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li><a href="index.html"><i class="fa fa-table"></i> <span class="nav-label">Graficas</span></a></li>
                    ...
                    <ul class="nav nav-second-level">
                         ...
                         <li class="active"><a href="..\GDXL\dds.aspx?Id=1"><i class="fa fa-tachometer"></i> <span class="nav-label">DDS</span></a></li>
