<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="carga.aspx.cs" Inherits="SMDL3.GD.carga" %>
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                         ...
                         <li class="active"><a href="..\GD\carga.aspx"><i class="fa fa-upload"></i> <span class="nav-label">Carga Manual</span></a></li>
                ...
                <div class="col-md-12">
                    <div class="ibox ">
                        <div class="ibox-title" style="height:100px;">
                            <h5>Dashboard GD [L3] - Carga Manual</h5>
