<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="bd.aspx.cs" Inherits="SMDL3.GD.bd" %>
<!DOCTYPE html>
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                         ...
                         <li class="active"><a href="..\GD\bd.aspx?Id=1"><i class="fa fa-area-chart"></i> <span class="nav-label">Indicadores</span></a></li>
                ...
                <div class="col-md-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-title" style="height:100px;">
                            <h5>Dashboard GD [L3] - Base de Datos</h5>
