<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="dds.aspx.cs" Inherits="SMDL3.GD.dds" %>
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                         ...
                         <li class="active"><a href="..\GD\dds.aspx?Id=1"><i class="fa fa-tachometer"></i> <span class="nav-label">DDS</span></a></li>
