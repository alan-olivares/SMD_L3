<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="targets.aspx.cs" Inherits="SMDL3.GDXL.targets" %>
<!DOCTYPE html>
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                         ...
                         <li class="active"><a href="..\GDXL\targets.aspx"><i class="fa fa-bullseye"></i> <span class="nav-label">Targets</span></a></li>
                    </ul>
                </li>
                <li>
                        ...
                        <form id="form1" runat="server">
                            <div class="ibox ">
                                <div class="ibox-title">
                                    ...
                                    <h2>Dashboard GD XL [L3] - Definición de Targets</h2>
                                </div>
                                    <div class="row">
                                        <div class="col-lg-3">
                                        <div class="ibox ">
                                            <div class="ibox-title">
                                                        <h5>INTENSITY GD XL [L3]</h5>
                                            </div>
                                            <div class="ibox-content">
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="185px" ID="Label1" runat="server" Text="GD XL KWH [KWh/MCE]" Height="35px"></asp:Label>
                                                                <asp:TextBox Width="70" ID="txt233" runat="server"  onkeypress="return isNumberKey(event)" type="text"  Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="185" ID="Label2" runat="server" Text="GD XL A.C. [Nm3/MCE]" Height="35px">   </asp:Label>
                                                                <asp:TextBox Width="70" ID="txt234" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="185" ID="Label3" runat="server" Text="GD XL Vacío [Nm3/MCE]" Height="35px">   </asp:Label>
                                                                <asp:TextBox Width="70" ID="txt235" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                            </div>
                                        </div>
                                        </div>
                                        ...
                                        <form>
                                            <div class="ibox ">
                                                ...
                                                <div class="ibox-content">
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="185" ID="Label5" runat="server" Text="KWH [KWh/MCE]" Height="35px"></asp:Label>
                                                                <asp:TextBox Width="70" ID="txt237" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="185" ID="Label6" runat="server" Text="Aire Comprimido [Nm3/MCE]" Height="35px">   </asp:Label>
                                                                <asp:TextBox Width="70" ID="txt238" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="185" ID="Label7" runat="server" Text="Vacío [Nm3/MCE]" Height="35px"></asp:Label>
                                                                <asp:TextBox Width="70" ID="txt239" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                </div>
                                            </div>
                                        </form>
                                        ...
                                        <div class="col-lg-3">
                                               <div class="ibox "> 
                                                    ...
                                                    <div class="ibox-content">
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="185px" ID="Label46" runat="server" Text="KWH"  Height="35px"></asp:Label>
                                                                <asp:TextBox Width="70px" ID="txt241" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="185px" ID="Label47" runat="server" Text="Aire Comprimido [Nm3/MCE]" Height="35px" >   </asp:Label>
                                                                <asp:TextBox Width="70px" ID="txt242" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="185px" ID="Label38" runat="server" Text="Vacío [Nm3/MCE]"  Height="35px"></asp:Label>
                                                                <asp:TextBox Width="70px" ID="txt243" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-3">
                                               <div class="ibox "> 
                                                    ...
                                                    <div class="ibox-content">
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="185px" ID="Label4" runat="server" Text="KWH [KWh/MCE]"  Height="35px"></asp:Label>
                                                                <asp:TextBox Width="70px" ID="txt245" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="185px" ID="Label8" runat="server" Text="Aire Comprimido [Nm3/MCE]" Height="35px" >   </asp:Label>
                                                                <asp:TextBox Width="70px" ID="txt246" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="185px" ID="Label9" runat="server" Text="Vacío [Nm3/MCE]"  Height="35px"></asp:Label>
                                                                <asp:TextBox Width="70px" ID="txt247" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                    </div>
                                               </div>
                                        </div>
