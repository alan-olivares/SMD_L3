<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="targets.aspx.cs" Inherits="SMDL3.FOCKE.targets" %>
<!DOCTYPE html>
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                         ...
                         <li class="active"><a href="..\FOCKE\targets.aspx"><i class="fa fa-bullseye"></i> <span class="nav-label">Targets</span></a></li>
                    </ul>
                </li>
                <li>
                        ...
                        <form id="form1" runat="server">
                            <div class="ibox ">
                                <div class="ibox-title">
                                    ...
                                    <h2>Dashboard FOCKE [L3] - Definición de Targets</h2>
                                </div>
                                    <div class="row">
                                        <div class="col-lg-4">
                                        <div class="ibox ">
                                            <div class="ibox-title">
                                                        <h5>INTENSITY FOCKE [L3]</h5>
                                            </div>
                                            <div class="ibox-content">
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="220" ID="Label1" runat="server" Text="FOCKE KWH [KWh/MCE]" Height="35px"></asp:Label>
                                                                <asp:TextBox Width="70" ID="txt319" runat="server"  onkeypress="return isNumberKey(event)" type="text"  Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="220" ID="Label2" runat="server" Text="FOCKE A.C. [Nm3/MCE]" Height="35px">   </asp:Label>
                                                                <asp:TextBox Width="70" ID="txt320" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="220" ID="Label3" runat="server" Text="FOCKE Vacío [Nm3/MCE]" Height="35px">   </asp:Label>
                                                                <asp:TextBox Width="70" ID="txt321" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                            </div>
                                        </div>
                                        </div>
                                            ...
                                            <div class="ibox ">
                                                ...
                                                <div class="ibox-content">
                                                            <div class="row" style="padding-left:10px">
                                                                ...
                                                                <asp:TextBox Width="60" ID="txt323" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="160" ID="Label6" runat="server" Text="Aire Comp. [Nm3/MCE]" Height="35px">   </asp:Label>
                                                                <asp:TextBox Width="60" ID="txt324" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="160" ID="Label7" runat="server" Text="Vacío [Nm3/MCE]" Height="35px"></asp:Label>
                                                                <asp:TextBox Width="60" ID="txt325" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                </div>
                                            </div>
                                        </form>
                                               ...
                                               <div class="ibox "> 
                                                    ...
                                                    <div class="ibox-content">
                                                            <div class="row" style="padding-left:10px">
                                                                ...
                                                                <asp:TextBox Width="60px" ID="txt327" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="160px" ID="Label47" runat="server" Text="Aire Comp. [Nm3/MCE]" Height="35px" >   </asp:Label>
                                                                <asp:TextBox Width="60px" ID="txt328" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="160px" ID="Label38" runat="server" Text="Vacío [Nm3/MCE]"  Height="35px"></asp:Label>
                                                                <asp:TextBox Width="60px" ID="txt329" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                    </div>
                                                </div>
                                               ...
                                               <div class="ibox "> 
                                                    ...
                                                    <div class="ibox-content">
                                                            <div class="row" style="padding-left:10px">
                                                                ...
                                                                <asp:TextBox Width="60px" ID="txt331" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="160px" ID="Label8" runat="server" Text="Aire Comp. [Nm3/MCE]" Height="35px" >   </asp:Label>
                                                                <asp:TextBox Width="60px" ID="txt332" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="160px" ID="Label9" runat="server" Text="Vacío [Nm3/MCE]"  Height="35px"></asp:Label>
                                                                <asp:TextBox Width="60px" ID="txt333" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                    </div>
                                               </div>
                                        </div>
                                               ...
                                               <div class="ibox "> 
                                                    ...
                                                    <div class="ibox-content">
                                                            <div class="row" style="padding-left:10px">
                                                                ...
                                                                <asp:TextBox Width="60px" ID="txt335" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="160px" ID="Label11" runat="server" Text="Aire Comp. [Nm3/MCE]" Height="35px" >   </asp:Label>
                                                                <asp:TextBox Width="60px" ID="txt336" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                            <div class="row" style="padding-left:10px">
                                                                <asp:Label Width="160px" ID="Label12" runat="server" Text="Vacío [Nm3/MCE]"  Height="35px"></asp:Label>
                                                                <asp:TextBox Width="60px" ID="txt337" runat="server" onkeypress="return isNumberKey(event)" type="text" Height="25px" style="text-align: right"></asp:TextBox>
                                                            </div>
                                                    </div>
                                               </div>
                                        </div>
