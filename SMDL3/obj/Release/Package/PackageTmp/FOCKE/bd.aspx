<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="bd.aspx.cs" Inherits="SMDL3.FOCKE.bd" %>
<!DOCTYPE html>
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                         ...
                         <li class="active"><a href="..\FOCKE\bd.aspx?Id=1"><i class="fa fa-area-chart"></i> <span class="nav-label">Indicadores</span></a></li>
                ...
                <div class="col-md-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-title">
                            <h2>Dashboard FOCKE [L3] - Base de Datos</h2>
                        </div>
