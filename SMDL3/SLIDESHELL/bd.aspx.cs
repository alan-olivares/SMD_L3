    ...
    public partial class bd : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                DataTable dt = Funciones.getDataTable("exec sp_Mod_getDatosSem_v2 '" + fecha + "',17");
                Panel1.Controls.Add(new Label { Text = Funciones.crearTablaBD(dt, semana, "SLIDE & SHELL [L3]").ToString() });
            }
        }
