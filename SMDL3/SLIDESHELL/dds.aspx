<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="dds.aspx.cs" Inherits="SMDL3.SLIDESHELL.dds" %>
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                         ...
                         <li class="active"><a href="..\SLIDESHELL\dds.aspx?Id=1"><i class="fa fa-tachometer"></i> <span class="nav-label">DDS</span></a></li>
                ...
                <div class="col-md-12">
                    <div class="ibox ">
                        <div class="ibox-title" style="height:100px;">
                            <h5>Dashboard SLIDE & SHELL [L3] - DDS</h5>
                            <div class="float-right">
                                <div class="form-inline text-center d-flex justify-content-center">
                                    <h5 style="margin-right:20px;"><label>Fecha:</label>
    ...
    <script src="../js/plugins/dataTables/dataTables.bootstrap4.min.js"></script>
        ...
        <script>
            function obtenerDatos() {
                location.href = './dds.aspx?fecha=' + $('#date1').val();
            }
